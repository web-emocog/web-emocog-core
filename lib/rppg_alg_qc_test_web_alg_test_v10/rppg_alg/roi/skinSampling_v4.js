...
export function sampleRectStatsV4(imageData, W, H, rect, opts = {}, excludeRects = []) { // Функция для выборки статистики из прямоугольной области
  if (!rect || ![rect.x, rect.y, rect.w, rect.h].every((v) => Number.isFinite(v))) {
    return {
      ok: false,
      r: 0, g: 0, b: 0,
      skinRatio: 0, skinPixels: 0, totalPixels: 0, skippedPixels: 0,
      lumaMean: 0, lumaStd: 0, satMean: 0,
      clippedRatio: 0, specularRatio: 0,
    };
  }
