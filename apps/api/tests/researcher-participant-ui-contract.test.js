...
describe('researcher navigation contract', () => {
  ...
  it('loads each stateful participant module through one cache version', () => {
    ...
    assert.match(tests, /ui-updated\.js\?v=20260913-6/);
    assert.match(app, /tests-updated\.js\?v=20260913-6/);
    assert.match(tests, /experimental_task-updated\.js\?v=20260913-6/);
    assert.match(task, /tests-updated\.js\?v=20260913-6/);
    assert.match(app, /session-runtime\/index\.js\?v=20260913-6/);
    assert.match(tests, /session-runtime\/index\.js\?v=20260913-6/);
    assert.match(task, /session-runtime\/index\.js\?v=20260913-6/);
    assert.match(runtime, /tests-updated\.js\?v=20260913-6/);
    assert.match(app, /protocol-invite-utils\.js\?v=20260913-6/);
    assert.match(tests, /protocol-invite-utils\.js\?v=20260913-6/);
    assert.match(task, /protocol-invite-utils\.js\?v=20260913-6/);
  });
